...
class NPMCTrainer():
    ...
    def train_one_model(self, 
        ...
        model = train_spectrum_model(model_cls = self.model_cls, 
                                     config = model_config, 
...
def train_spectrum_model(config,
        ...
        trainer.validate(dataloaders=data_module.val_dataloader(), ckpt_path='best')
...
def tune_npmc(model_cls, 
    ...
    default_wandb_config = {'project': default_wandb_project,
