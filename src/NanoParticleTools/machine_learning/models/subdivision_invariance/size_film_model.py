...
class SubdivisionInvariantRepresentation(nn.Module):
    ...
    def __init__(self,
        ...
        self.geometric_film_layer = FiLMLayer(4, embed_dim, intermediate_film_dim)
    ...
    def forward(self,
        ...
        x_embedding = self.geometric_film_layer(x_embedding, radii[x_layer_idx][node_dopant_index].reshape(-1, 4))
